  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
      <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
          <div>
            <img src="../../public/logo.svg"
              className="w-mx-auto max-w-[200px] max-h-[200px] w-[50px] h-[50px]" />
          </div>
        ...
        <div className="flex-1 bg-green-100 text-center overflow-hidden lg:flex rounded-tr-lg rounded-br-lg">
          <div className="w-full bg-contain bg-center bg-no-repeat bg-cover background-image">
          </div>
        </div>
      </div>
    </div>
